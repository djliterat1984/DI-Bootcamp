...
-- SELECT customer.create_date FROM customer GROUP BY create_date;
...
-- SELECT film_id, title, description, length, rental_rate FROM film 
-- WHERE film.title LIKE ('Ba%')

-- -- 10.Write a query which will find the 10 cheapest movies. 
-- -- I don't know how to find cheapest movies
...
-- SELECT DISTINCT customer.customer_id, customer.first_name, customer.last_name, payment.amount, payment.payment_date
-- FROM customer
-- INNER JOIN payment
