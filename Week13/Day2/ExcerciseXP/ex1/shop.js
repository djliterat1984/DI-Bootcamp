...
const searchByProduct = ( productName ) => {
	const productSelected = productList.filter( value => value.name.toLowerCase() === productName.toLowerCase() )
	console.log(productSelected);
}

searchByProduct('basket ball')