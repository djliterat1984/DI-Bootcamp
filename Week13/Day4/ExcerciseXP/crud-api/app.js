...
// and Axios to retrieve data from the JSONPlaceholder API and respond with that data in your own API. 
...
// 3.In dataService.js, import the axios module and create a function named fetchPosts 
// that makes a GET request to the JSONPlaceholder API to fetch data for all posts.
...
// 2.Create an endpoint in your Express app that uses the fetchPosts function from the dataService module 
